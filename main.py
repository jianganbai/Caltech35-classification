...
if __name__ == '__main__':
    ...
    parser.add_argument('--L1', action='store_true', default=False, help='add L1 regularization')
    parser.add_argument('--L2', action='store_true', default=False, help='add L2 regularization')
    parser.add_argument('--MSE', action='store_true', default=False)
    parser.add_argument('--add_real', action='store_true', default=False, help='use additional datasets')
    parser.add_argument('--wrong_prop', type=float, default=0.0, help='wrong label proposition')
    parser.add_argument('--train_tsne', action='store_true', default=True, help='do tsne on train dataset')
    parser.add_argument('--eval', action='store_true', default=False, help='for analysis.py')
